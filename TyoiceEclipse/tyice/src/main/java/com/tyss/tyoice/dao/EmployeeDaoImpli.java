...
public class EmployeeDaoImpli implements EmployeeDao {
	...
	public List<Employee> getAllEmps() {
		...
		EntityManager manager = factory.createEntityManager();
		try {
			String get = "from Employee";
			query = (Query<Employee>) manager.createQuery(get);
	...
	@Override
	public List<ClientProject> getbyProjectId(int empId) {
		EntityManager manager = factory.createEntityManager();
		String get = "from ClientProject where empId =: empId";
		Query query = (Query) manager.createQuery(get);
		query.setParameter("empId", empId);
		List<ClientProject> pros = query.getResultList();
		if (pros != null) {
			return pros;
		}
		return null;
	...
	@Override
	public List<Employee> getEmpsByProjId(int projId) {
		EntityManager manager = factory.createEntityManager();
		String get = "from Employee where projId =: projId";
		Query query = (Query) manager.createQuery(get);
		query.setParameter("projId", projId);
		List<Employee> pros = query.getResultList();
		if (pros != null) {
			return pros;
		}
		return null;
