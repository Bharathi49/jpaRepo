...
public class ClientdaoImpl implements Clientdao {
	...
	public ClientsInfoResponse getClientDeatils(int id) {
		...
		Iterator<Object> invItr = null;
		Object[] commonArray = null;
		ClientsInfoResponse responce = null;
		...
		try {
			...
			responce = new ClientsInfoResponse();
			while (invItr.hasNext()) {
				commonArray = (Object[]) invItr.next();
	...
	@Override
	public Set<String> getStackUnique(int compId) {
	...
	public ClientsInfoResponse getYearSet(int clientId) {
		...
		try {
			...
			while (invItr.hasNext()) {
				commonArray = (Object[]) invItr.next();
				if (commonArray[0] != null && commonArray[1] != null)
					map2.put(Integer.parseInt(commonArray[0].toString()), Integer.parseInt(commonArray[1].toString()));
			}
